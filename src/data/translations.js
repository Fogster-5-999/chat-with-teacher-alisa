...
Object.assign(optionLabels, {
    d1_apologize: 'Прости, завал на учёбе, можно пересдать?',
    d1_ask_help: 'Я запутался, можешь ещё раз объяснить?',
    d1_joke: 'Мой мозг сегодня официально в отпуске, исправлюсь',
    d1_flirt_early: 'Если вы так пишете вечером, я начну ждать сообщений 😏',
    d1_schedule_calm: 'Как тебе удобно, подстроюсь под время',
    ...
    d2_photo_kind: 'Тебе идёт, спокойно и без лишнего',
    d2_photo_honest: 'Нормальное фото, живое, не как для отчёта',
    d2_photo_joke: 'Кафедра теперь обязана повысить тебе рейтинг',
    d2_photo_flirt: 'Если честно, я бы это фото пересматривал',
    d2_cafe_study: 'Мне бы как раз разбор темы не помешал',
    d2_cafe_home: 'Лучше дома доделаю, пришли материалы',
    d2_cafe_joke: 'Если кофе хороший, конспект усвоится быстрее 😄',
    d2_cafe_date: 'То есть это почти приглашение на свидание?',
    d3_come_study: 'Приду с вопросами по теме, не дам тебе скучать',
    d3_come_honest: 'Хочу прийти, но только если тебе правда ок',
    d3_stay_home: 'Сегодня останусь дома, не хочу мешать',
    d3_come_pushy: 'Приду, а там забудем про ваши правила',
    d3_remote_study: 'Нужен разбор, скидывай, что делать',
    d3_remote_checkin: 'Как ты сама, не только же работы проверять',
    d3_remote_leave: 'Тогда не отвлекаю, хороших выходных',
    d3_after_thanks: 'Спасибо за сегодня, мне было спокойно',
    ...
    d4_joke: 'Это потому что я обаятельный, но тихо 😄',
    d4_confess_early: 'Я весь день думаю о тебе, не могу скрывать',
    d4_support_space: 'Понимаю, не буду тянуть из тебя ответы',
    d4_support_transfer: 'Если что, я готов перевестись к другому преподавателю',
    d4_support_joke: 'Завтра ты всех переживёшь, у тебя вид профессионала',
    d4_support_pressure: 'Скажи, кто она, я сам с ней поговорю',
    ...
    d5_route_careful: 'Давай сделаем паузу и не будем прятаться',
    ...
    d5_commit_risk: 'Я всё равно хочу попробовать, несмотря на риск',
    d5_commit_stop: 'Нет, давай закончим это сейчас',
    d6_park_come: 'Приду, просто поговорим спокойно',
    d6_park_nervous: 'Мне страшно, но я приду',
