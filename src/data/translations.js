 ...
 *      вместо текста покажется голый id (например «d5_truth»);
...
export const translations = {
    ru: {
        ...
        'settings.notifications': 'Громкость уведомлений',
        ...
        'legal.welcome1': 'Добро пожаловать',
        'legal.welcome2': 'в чат с Алисой!',
        'legal.point1': 'Это интерактивная история. Все персонажи — совершеннолетние личности.',
        'legal.point2': 'События и диалоги полностью вымышленные и созданы исключительно в развлекательных целях.',
        'legal.point3': 'Любые совпадения с реальными людьми или организациями случайны.',
        'legal.accept': 'Понятно'
    },
...
// Current story option labels. Keep these ids in sync with the day scripts so
// the player's chat bubble never shows a technical id.
Object.assign(optionLabels, {
    d1_apologize: 'Простите, завал на учёбе, можно пересдать?',
    d1_ask_help: 'Я запутался, можете ещё раз объяснить?',
    d1_joke: 'Сегодня на расслабленном, исправлюсь',
    d1_flirt_early: 'А вы почаще пишите и я начну ждать сообщений 😏',
    d1_schedule_calm: 'Как вам удобно, подстроюсь под время',
    d1_schedule_self: 'Сделаю сам и пришлю, когда будет готово',
    d1_schedule_now: 'А сегодня никак, хочу закрыть это сразу',
    d1_schedule_video: 'Может, по видео, так интереснее будет',
    d2_photo_kind: 'Вам это точно идёт',
    d2_photo_honest: 'Живое фото, а не как для отчёта',
    d2_photo_joke: 'Кафедра теперь обязана вам премией)',
    d2_photo_flirt: 'Будет, что вспоминать 😏',
    d2_cafe_study: 'Мне бы как раз разбор темы не помешал',
    d2_cafe_home: 'Лучше дома доделаю, пришлите материалы',
    d2_cafe_joke: 'Если кофе хороший, конспект усвоится быстрее 😄',
    d2_cafe_date: 'То есть это почти приглашение на свидание?',
    d3_come_study: 'Приду с вопросами по теме, не дам вам скучать',
    d3_come_honest: 'Хочу прийти, но только если вам правда ок',
    d3_stay_home: 'Сегодня останусь дома, не хочу мешать',
    d3_come_pushy: 'Приду, а там забудем про ваши правила',
    d3_remote_study: 'Нужен разбор, скидывайте, что делать',
    d3_remote_checkin: 'Как вы сами, не только же работы проверять',
    d3_remote_leave: 'Тогда не отвлекаю, хороших выходных',
    d3_after_thanks: 'Спасибо за сегодня, было необычно',
    d3_after_study: 'Добрался, и тему наконец понял',
    d3_after_personal: 'А можно спросить не по учёбе?',
    d3_after_flirt: 'Теперь сложно делать вид, что это была просто учёба',
    d4_listen: 'Мне тоже было хорошо, без лишних слов',
    d4_study: 'Я всё-таки доделаю задания, пока настрой есть',
    d4_joke: 'Это потому что я обаятельный)))',
    d4_confess_early: 'Я все думаю о вас, не могу молчать',
    d4_support_space: 'Понимаю, не буду тянуть из вас ответы',
    d4_support_transfer: 'Если что, я готов перевестись к другому преподу',
    d4_support_joke: 'Пф, руководитель — тоже человек. Вы справитесь',
    d4_support_pressure: 'Скажите, кто она, я сам с ней поговорю',
    d5_reassure: 'Я на связи. Я с тобой, разберёмся',
    d5_truth: 'Будь честной, не надо придумывать удобную версию',
    d5_transfer: 'Давай попробуем оформить мой перевод к другому преподавателю',
    d5_lie: 'Скажи, что это были только занятия, так проще',
    d5_take_over: 'Дай контакт руководителя, я сам всё объясню',
    d5_route_careful: 'Давай притормозим и не будем прятаться',
    d5_route_clean: 'Ждём перевод и держимся формально до решения',
    d5_route_risk: 'Я не хочу тебя терять, даже если это риск',
    d5_route_distance: 'Наверное, нам нужно остановиться',
    d5_distance_confirm: 'Да, давай не растягивать это',
    d5_distance_pause: 'Не хочу разрыва, мне просто нужна пауза',
    d5_distance_apologize: 'Прости, я испугался, а не хотел уйти',
    d5_commit_clean: 'Сначала перевод, потом честно поговорим обо всём',
    d5_commit_wait: 'Я рядом, но не буду тебя торопить',
    d5_commit_risk: 'Я всё равно хочу попробовать, несмотря на все',
    d5_commit_stop: 'Нет, давай закончим это',
    d6_park_come: 'Приду, просто спокойно поговорим',
    d6_park_nervous: 'Мне стремно, но я приду',
    d6_park_wait: 'Не готов к такой встрече, давай не завтра',
    d6_park_secret: 'Приду, только чтобы никто не видел',
    d7_commit: 'Я хочу быть с тобой, и готов отвечать за это',
    d7_wait: 'Давай не торопиться, мне важнее не сломать всё',
    d7_open: 'Не знаю, как это назвать, но хочу оставить связь',
    d7_stop: 'Думаю, нам лучше остановиться'
});
