...
export const day5_1 = {
  ...
  steps: [
    ...
    { type: 'branch', onChoice: 'day5_first_response', branches: {
      ...
      d5_take_over: [
        { type: 'reaction', sender: 'alisa', textKey: 'Нет!' },
        { type: 'reaction', sender: 'alisa', textKey: 'Не смей ей писать или говорить что-то' },
        { type: 'reaction', sender: 'alisa', textKey: 'Я сама решу что с этим делать.' },
...
export const day5_2 = {
  ...
  steps: [
    { type: 'messages', list: [
      ...
      { sender: 'alisa', textKey: 'Но пока надо держать дистанцию' }
    ] },
    ...
    { type: 'if', check: { hasFlag: 'pushedTooFast' }, then: [
      { type: 'messages', list: [
        { sender: 'alisa', textKey: 'Давай без такого напора' },
        { sender: 'alisa', textKey: 'Хорошо?' },
        { sender: 'alisa', textKey: 'Сейчас мне это не поможет, а только мешает.' }
      ] }
    ] },
    { type: 'messages', list: [
